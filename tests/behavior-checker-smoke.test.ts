...
const CASES: readonly IdentityCase[] = [
  ...
  { nodeId: "node_0017", sourceRelative: "src/core/nodes/node-id.ts" },
  { nodeId: "node_0022", sourceRelative: "src/core/project/paths.ts" },
  { nodeId: "node_0109", sourceRelative: "src/runtime/effects/io.ts" },
  { nodeId: "node_0131", sourceRelative: "src/runtime/legend/frontier-tagger.ts" },
  ...
  { nodeId: "node_0186", sourceRelative: "src/walker/actions/proposals-from-walker.ts" },
  { nodeId: "node_0217", sourceRelative: "src/walker/state/shadow-status.ts" },
  { nodeId: "node_0223", sourceRelative: "src/runtime/llm/ensemble.ts" },
  { nodeId: "node_0225", sourceRelative: "src/runtime/legend/reps-aggregator.ts" },
  { nodeId: "node_0227", sourceRelative: "src/schemas/workflow.ts" },
];
