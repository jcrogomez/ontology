...
declare -a FILES=(
  ...
  "src/kernel/core/integrity/hash.ts|pure-transform"
  "src/laws/topos/predicate.ts|algebraic-lawful"
  "src/laws/topos/omega.ts|algebraic-lawful"
  "src/laws/effects/result.ts|algebraic-lawful"
  "src/laws/effects/laws.ts|algebraic-lawful"
  "src/laws/render-ascii.ts|pure-transform"
  "src/laws/vocab-gap.ts|pure-transform"
  "src/laws/matrix-intersections.ts|pure-transform"
  "src/kernel/graph/poset.ts|pure-transform"
  "src/inverse/static/edges.ts|pure-transform"
  # Predicted resistant (8) — hypothesis §5
  "src/surfaces/commands/init.ts|cli-parsing"
  "src/surfaces/commands/walk.ts|cli-parsing"
  "src/surfaces/commands/runs/show.ts|cli-parsing"
  "src/kernel/core/fs/lock.ts|io-bound"
  "src/kernel/core/state/state-store.ts|io-bound"
  "src/runtime/llm/anthropic/adapter.ts|adapter-boundary"
  "src/runtime/llm/ollama/adapter.ts|adapter-boundary"
  "src/inverse/translator.ts|prompt-sensitive"
  # Edge cases (2)
  "src/laws/effects/index.ts|barrel"
  "src/laws/topos/index.ts|barrel"
)
